...
import { htmlCodeBlocks } from '../../../../../constants/data/htmlcode';
  ...
  return (
    <div className="w-full flex flex-col bg-white py-[60px] px-16">
      <div className={`w-full bg-zinc-100 flex flex-col items-center justify-center gap-6 py-4`}>
        <h2 className='text-3xl text-center font-extrabold text-slate-900 '>HTML Cheat Sheet</h2>
        <p className='text-[20px] text-slate-700 text-center'>Learn the main HTML tags and attributes to quickly build and organize web pages. Great for beginners.</p>
      </div>
