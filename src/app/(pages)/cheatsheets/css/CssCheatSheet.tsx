...
import { cssCodeBlocks } from '../../../../../constants/data/csscode';
  ...
  return (
    <div className="w-full flex flex-col bg-white py-[60px] px-16">
      <div className={`w-full bg-zinc-100 flex flex-col items-center justify-center gap-6 py-4`}>
        <h2 className='text-3xl text-center font-extrabold text-slate-900 '>CSS Cheat Sheet</h2>
        <p className='text-[20px] text-slate-700 text-center'>Find the key CSS properties and rules to style your web pages easily. Perfect for quick and easy reference.</p>
      </div>
